...
<body>
	...
	<div class="formbody">
		...
		<form action="${pageContext.request.contextPath }/newuser.action"
			method="post" id="fm" target="_top">

			<ul class="forminfo">
				<li><label>账户</label><input name="username" type="text"
					class="dfinput" /><i></i></li>
				<li><label>新密码</label><input name="password" id="newPwd"
					type="password" class="dfinput" /><i></i></li>
				<li><label>确认密码</label><input name="" id="cfPwd"
					type="password" class="dfinput" /><i></i></li>
